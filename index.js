...
async function run() {
  try {
    ...
    // Run few checks
    await exec.exec("sudo ls -a /github");
    await exec.exec("sudo ls -a /github/home");
    await exec.exec("sudo ls -a /github/workspace");
    await exec.exec("sudo ls -a /github/workflow");
    if (removeCanary) {
